...
void Fast_File( _Sagan_Event *Event )
{
    ...
    fprintf( sagan_fast_stream, "%s [**] [1:%" PRIuFAST64 ":%" PRIuFAST32 "] %s [**] [Classification: %s] [Priority: %d] [Program: %s] ", timebuf,
             Event->sid, Event->rev, Event->f_msg, Event->class, Event->pri, Event->program);
