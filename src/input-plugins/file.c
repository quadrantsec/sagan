...
/* file.c - reads data in from a non-compressed, ASCII files */
...
void File_Input( const char *input_file )
{
    ...
    Sagan_Log(NORMAL, "Successfully opened uncompressed file %s....  processing events.....", input_file);
